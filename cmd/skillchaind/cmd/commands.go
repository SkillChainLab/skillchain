...
import (
	...
	"github.com/SkillChainLab/skillchain/app"
)
...
// genesisCommand builds genesis-related `skillchaind genesis` command. Users may provide application specific commands as a parameter
