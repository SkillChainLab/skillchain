...
// SkillchainKeeper interface defines methods exposed by skillchain module for use by other modules
type SkillchainKeeper interface {
	...
	GetUserVUSDPosition(ctx context.Context, address string) (UserVUSDPosition, bool)
}
